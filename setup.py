...
from amtt.test import TestCommand


def get_version():
    """parse _version for version number instead of importing the file, see
    http://stackoverflow.com/questions/458550/standard-way-to-embed-version-into-python-package"""
    INIT_LINES = open('amtt/__init__.py').readlines()
    VERSION_STRING_LINE = [l for l in INIT_LINES if '__version__' in l][0]
